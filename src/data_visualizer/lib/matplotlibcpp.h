...
/// See: https://matplotlib.org/3.2.1/api/_as_gen/matplotlib.pyplot.plot.html
    ...
    bool plot(const std::vector<Numeric> &x, const std::vector<Numeric> &y,
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_plot, args,
                                      kwargs);
...
// a non-numpy alternative for `detail::get_2darray()`.
    ...
    bool fill(const std::vector<Numeric> &x, const std::vector<Numeric> &y,
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_fill, args,
                                      kwargs);
    ...
    bool arrow(Numeric x, Numeric y, Numeric end_x, Numeric end_y, const std::string &fc = "r",
               const std::string ec = "k", Numeric head_length = 0.25,
        ...
        PyObject *res =
                PyObject_Call(detail::_interpreter::get().s_python_function_arrow, plot_args,
                              kwargs);
    ...
    bool hist(const std::vector<Numeric> &y, long bins = 10, std::string color = "b",
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_hist, plot_args,
                                      kwargs);
    ...
    namespace detail {
        ...
        inline void
        imshow(void *ptr, const NPY_TYPES type, const int rows, const int columns, const int colors,
    ...
    inline void
    imshow(const unsigned char *ptr, const int rows, const int columns, const int colors,
    ...
    void imshow(const cv::Mat &image, const std::map<std::string, std::string> &keywords = {})
{
    ...
    bool scatter(const std::vector<NumericX> &x,
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_scatter,
                                      plot_args, kwargs);
    ...
    bool boxplot(const std::vector<std::vector<Numeric>> &data,
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_boxplot, args,
                                      kwargs);
    ...
    bool contour(const std::vector<NumericX> &x, const std::vector<NumericY> &y,
        ...
        PyObject *res =
                PyObject_Call(detail::_interpreter::get().s_python_function_contour, plot_args,
                              kwargs);
    ...
    bool semilogx(const std::vector<NumericX> &x, const std::vector<NumericY> &y,
        ...
        PyObject *res = PyObject_CallObject(detail::_interpreter::get().s_python_function_semilogx,
                                            plot_args);
    ...
    bool semilogy(const std::vector<NumericX> &x, const std::vector<NumericY> &y,
        ...
        PyObject *res = PyObject_CallObject(detail::_interpreter::get().s_python_function_semilogy,
                                            plot_args);
    ...
    bool loglog(const std::vector<NumericX> &x, const std::vector<NumericY> &y,
        ...
        PyObject *res = PyObject_CallObject(detail::_interpreter::get().s_python_function_loglog,
                                            plot_args);
    ...
    bool errorbar(const std::vector<NumericX> &x, const std::vector<NumericY> &y,
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_errorbar,
                                      plot_args, kwargs);
    ...
    bool named_plot(const std::string &name, const std::vector<Numeric> &y,
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_plot, plot_args,
                                      kwargs);
    ...
    bool named_semilogx(const std::string &name, const std::vector<Numeric> &x,
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_semilogx,
                                      plot_args, kwargs);
    ...
    bool named_semilogy(const std::string &name, const std::vector<Numeric> &x,
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_semilogy,
                                      plot_args, kwargs);
    ...
    bool named_loglog(const std::string &name, const std::vector<Numeric> &x,
        ...
        PyTuple_SetItem(plot_args, 1, yarray);
        PyTuple_SetItem(plot_args, 2, pystring);
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_loglog,
                                      plot_args, kwargs);
    ...
    void text(Numeric x, Numeric y, const std::string &s = "") {
        ...
        PyObject *res = PyObject_CallObject(detail::_interpreter::get().s_python_function_text,
                                            args);
    ...
    inline void
    colorbar(PyObject *mappable = NULL, const std::map<std::string, float> &keywords = {}) {
        if (mappable == NULL)
            throw std::runtime_error(
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_colorbar, args,
                                      kwargs);
    ...
    void ylim(Numeric left, Numeric right) {
        ...
        PyObject *res = PyObject_CallObject(detail::_interpreter::get().s_python_function_ylim,
                                            args);
    ...
    template<typename Numeric>
    inline void
    xticks(const std::vector<Numeric> &ticks, const std::vector<std::string> &labels = {},
           const std::map<std::string, std::string> &keywords = {}) {
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_xticks, args,
                                      kwargs);
    ...
    template<typename Numeric>
    inline void
    yticks(const std::vector<Numeric> &ticks, const std::vector<std::string> &labels = {},
           const std::map<std::string, std::string> &keywords = {}) {
        assert(labels.size() == 0 || ticks.size() == labels.size());
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_yticks, args,
                                      kwargs);
    ...
    inline void tick_params(const std::map<std::string, std::string> &keywords,
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_tick_params,
                                      args, kwargs);
    ...
    inline void subplot(long nrows, long ncols, long plot_number) {
        ...
        PyObject *res = PyObject_CallObject(detail::_interpreter::get().s_python_function_subplot,
                                            args);
    ...
    inline void
    subplot2grid(long nrows, long ncols, long rowid = 0, long colid = 0, long rowspan = 1,
                 long colspan = 1) {
        detail::_interpreter::get();
    ...
    title(const std::string &titlestr, const std::map<std::string, std::string> &keywords = {}) {
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_title, args,
                                      kwargs);
    ...
    inline void suptitle(const std::string &suptitlestr,
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_suptitle, args,
                                      kwargs);
    ...
    inline void axis(const std::string &axisstr) {
        ...
        PyObject *res = PyObject_CallObject(detail::_interpreter::get().s_python_function_axis,
                                            args);
        if (!res) throw std::runtime_error("Call to title() failed.");
    ...
    inline void axvline(double x, double ymin = 0., double ymax = 1.,
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_axvline, args,
                                      kwargs);
    ...
    inline void axvspan(double xmin, double xmax, double ymin = 0., double ymax = 1.,
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_axvspan, args,
                                      kwargs);
        Py_DECREF(args);
        Py_DECREF(kwargs);
    ...
    xlabel(const std::string &str, const std::map<std::string, std::string> &keywords = {}) {
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_xlabel, args,
                                      kwargs);
    ...
    ylabel(const std::string &str, const std::map<std::string, std::string> &keywords = {}) {
        ...
        PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_ylabel, args,
                                      kwargs);
    ...
    inline void grid(bool flag) {
        ...
        PyObject *res = PyObject_CallObject(detail::_interpreter::get().s_python_function_grid,
                                            args);
    ...
    inline void pause(Numeric interval) {
        ...
        PyObject *res = PyObject_CallObject(detail::_interpreter::get().s_python_function_pause,
                                            args);
    ...
    inline void save(const std::string &filename) {
        ...
        PyObject *res = PyObject_CallObject(detail::_interpreter::get().s_python_function_save,
                                            args);
 ...
 */
    ...
    public:
        ...
        Plot(const std::string &name, const std::vector<Numeric> &x, const std::vector<Numeric> &y,
            ...
            PyObject *res = PyObject_Call(detail::_interpreter::get().s_python_function_plot,
                                          plot_args, kwargs);
